...
public class IntakeConfig {
    ...
    public double frontCommunityTopSpeed = 3650; // correct 4820 wrong //3800 was a little too far
    public double launcherCommunityTopSpeed = 3650; // correct //3800 was a little too far
