...
public class ElevatorDelay extends CommandBase {
  ...
  /** 
   * Creates a new ElevatorDelay. Elevator will move to safePos, wait for FourBar to be at conditional percentage, then move to finalPos
   ...
   * @param conditionalPercent percentage that FourBar must be at before Elevator will move to finalPos ex: 40% = 40 not .40
   */
