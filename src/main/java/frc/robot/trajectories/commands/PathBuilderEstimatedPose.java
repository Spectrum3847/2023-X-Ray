...
public
class PathBuilderEstimatedPose { // Used to create paths for Autonomus and for On-the-Fly Generation
    public static final SwerveAutoBuilder pathBuilder =
            new SwerveAutoBuilder(
                    ...
                    // rotation controller)
                    Robot.swerve
                            ::setModuleStatesAuto, // Module states consumer used to output to the
                    // drive
                    // subsystem
